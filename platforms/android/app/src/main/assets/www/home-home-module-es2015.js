...
let HomePage = class HomePage {
    constructor(geolocation, deviceOrientation, platform) {
    ...
    locate() {
        this.geolocation.getCurrentPosition().then((resp) => {
            ...
            let myLocation = new geodesy_latlon_spherical_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.latitude, this.longitude);
            this.printLatLng = myLocation;
            this.kaabaLocation = new geodesy_latlon_spherical_js__WEBPACK_IMPORTED_MODULE_2__["default"](21.422499, 39.826194);
    ...
    startWatching() {
        this.watch = this.deviceOrientation.watchHeading()
            ...
            let compass = document.getElementsByClassName('compass');
            if (compass.length !== 0) {
